(() => {
    ...
    if (menuBurger) menuBurger.addEventListener("click", (function(e) {
        ...
        if (bodyBg) bodyBg.classList.toggle("_bg-active");
        if (headerBg) headerBg.classList.toggle("_bg-active-header");
    }));
    if (menuBody) menuBody.addEventListener("click", (function(e) {
        ...
        if (bodyBg) bodyBg.classList.remove("_bg-active");
        if (headerBg) headerBg.classList.remove("_bg-active-header");
    }));
